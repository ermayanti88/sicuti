...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti Pegawai Dinas Komunikasi Informatika dan 
		Statika Kota Banjarmasin- </title>
...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	<div class="navbar-header">
		...
		<a class="navbar-brand hidden-xs" href="index.php">
			...
			<div class="float-right">&nbsp;<strong>Dinas Komunikasi Informatika dan Statika Kota Banjarmasin</strong></div>
			<div class="clear-both"></div>
		</a>
		<a class="navbar-brand visible-xs" href="index.php">
			<img src="libs/images/logo.JPG" alt="brand" width="32" class="float-left image-brand">
			<div class="float-right">&nbsp;<strong>Dinas Komunikasi Informatika dan Statika Kota Banjarmasin</strong></div>
			<div class="clear-both"></div>
		</a>
	</div>/.navbar-header -->
	...
	<ul class="nav navbar-top-links navbar-right">
            ...
            <div class="navbar-header" >
				...
				<a class="navbar-brand hidden-xs" href="admin.php">
					...
					<div class="float-right">&nbsp;<strong style="color: black;">Dinas Komunikasi Informatika dan Statika Kota Banjarmasin</strong></div>
					<div class="clear-both"></div>
				</a>
				<a class="navbar-brand visible-xs" href="index.php">
					<img src="libs/images/logopemko.png" alt="brand" width="32" class="float-left image-brand">
                    ...
                    <ul class="nav" id="side-menu" >
							...
							<ul class="nav nav-second-level"  >
								<?php
									...
									if($pagedesc =="Jenis Cuti"){
										echo '<li><a href="Jenis_cuti.php" class="active">Jenis_Cuti</a></li>';
									}
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							...
							<ul class="nav nav-second-level">
								...
								// if($pagedesc =="Ditolak"){
								// 	echo '<li><a href="laporan2.php" class="active">Ditolak</a></li>';
								// }
								// else{
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-user fa-fw"></i>&nbsp;Keluar<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Logout") {
