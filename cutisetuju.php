...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Data Cuti Yang Disetujui</h1>
			</div><!-- /.col-lg-12 -->
		</div><!-- /.row -->
				...
				<div class="panel panel-default">
                    ...
                    if ($pegawai['id_pegawai']!= 32) {
						...
						$Sql = "SELECT cuti.*, pegawai.*, jeniscuti.nama_jenis
												...
												WHERE cuti.keterangan = 'Verifikasi Kadis' $where;"; 
							...
							<tbody>
								...
								while ($data = mysqli_fetch_array($Qry)) {
									...
									echo '<td class="text-center">
									 <a href="download.php?file='.$data['id_cuti'].'.docx" class="btn btn-sm btn-warning ">Cetak</a>
