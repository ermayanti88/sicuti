...
$sql = "UPDATE cuti SET `status`='$status', keterangan = '$hasilArray' WHERE id_cuti=$no_cuti";
$query = mysqli_query($conn, $sql);

if ($query) {
    echo "<script type='text/javascript'>
			alert('Penolakan cuti berhasil!'); 
			document.location = 'cuti_ditolak_a.php'; 
		</script>";

} else {
    echo "<script type='text/javascript'>
			alert('Terjadi kesalahan, silahkan coba lagi!.'); 
			document.location = 'menunggu.php'; 
		</script>";
}
?>
