...
if ($id !== null) 
{
    $query = mysqli_query($conn, "SELECT * FROM cuti WHERE id_pegawai = ". $id );
...
<!-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="radio" name="keterangan"  value="Tanggal sama dengan Pegawai lain" > Tanggal Bentrok
                                <input type="radio" name="keterangan" value="Masa cuti habis"> Masa cuti habis
                            </div>
                        </div>
