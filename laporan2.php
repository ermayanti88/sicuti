          ...
          <div class="panel-body">
            ...
            <div class="row">
              ...
              <tbody>
                ...
                INNER JOIN jeniscuti ON cuti.id_jeniscuti=jeniscuti.id_jeniscuti WHERE cuti.status = 'Ditolak' OR cuti.keterangan = 'Verifikasi Kadis'  ";
                ...
                foreach ($results as $result) : ?>
                  <tr>
                    ...
                    <?php
											 ...
											 if($st == 'Diajukan' && $ket == ''){
												 ?>
												   <a href="alasan_tolak.php?id=<?= $result["id_cuti"];?>" class="btn btn-danger btn-sm " style="margin-bottom: 5px;" onclick="return confirm('apakah anda yakin menolak cuti <?= $data['nama_pegawai']; ?>')">Tolak</a>
											 ...
											 <?php
											   ...
											   ?>
											   <a href="cetak.php?id_cuti=' . $data['id_cuti'] . '" class="btn btn-warning btn-xs">CETAK</a>
											   <?php
											 }
									 ?>
